...
public class UserResource {
    ...
    public ResponseEntity<Map<String,String>> updateUser(@Valid @RequestBody UserDTO userDTO){
    ...
    public ResponseEntity<Map<String,String>> addRoleToUser(@PathVariable("userId") Long userId,
    ...
    public ResponseEntity<Map<String,String>> removeRoleToUser(@PathVariable("userId") Long userId,
                                                @PathVariable("roleId") Long roleId){
